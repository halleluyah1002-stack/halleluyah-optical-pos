...
def pos():
    ...
    if request.method == "POST":
        ...
        for product in product_list:
            ...
            # LENS PRODUCTS: support half pair and 1 pair under the same product.
        ...
        if not selected_items:
            return page(
                "No Product Selected",
                "<div class='card'><h2>No Product Selected</h2><p>Please select Half Pair, 1 Pair, Custom Qty, or enter quantity for at least one product.</p><a class='btn' href='/pos'>Back</a></div>"
            )
    ...
    <div class="card">
        ...
        <p class="small">American-standard optical checkout: select Half Pair or 1 Pair under each lens power. Use Custom Qty for wholesale or special orders.</p>
                ...
                <tr>
                    ...
                    <td>
                        {% if 'Lens' in p.category %}
                            <p class="small"><b>Select power and sale type:</b> Half Pair = 1 lens, 1 Pair = 2 lenses, Custom = manual quantity.</p>
                            <table>
