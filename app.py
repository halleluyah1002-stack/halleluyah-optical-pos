...
/* ===== BEGINNER-FRIENDLY NEW USER UX ===== */
.nav-help{display:block;font-size:11px;font-weight:500;opacity:.78;margin-top:3px;line-height:1.25;color:#dbeafe}.simple-nav-link{display:block!important}.simple-nav-link strong{display:block;font-size:14px}.beginner-hero{background:linear-gradient(135deg,#ffffff,#eef6ff);border-left:6px solid var(--primary)}.beginner-actions{display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:14px;margin-top:12px}.beginner-action-card{display:flex;flex-direction:column;justify-content:center;gap:6px;padding:20px;border-radius:18px;color:#fff!important;text-decoration:none;min-height:120px;box-shadow:0 8px 22px rgba(15,23,42,.12)}.beginner-action-card b{font-size:20px}.beginner-action-card span{font-size:13px;opacity:.95;font-weight:500}.help-note{background:#eef6ff;border-left:5px solid var(--primary);border-radius:14px;padding:13px 14px;margin:10px 0;color:#0f172a}.beginner-steps{display:grid;grid-template-columns:repeat(auto-fit,minmax(120px,1fr));gap:10px}.beginner-step{background:#eef6ff;border:1px solid #dbeafe;border-radius:14px;padding:12px;text-align:center;font-weight:800}.beginner-step span{display:block;font-size:12px;font-weight:600;color:#475569;margin-top:4px}.dark .beginner-hero,.dark .help-note,.dark .beginner-step{background:#111827!important;color:#f8fafc!important;border-color:#334155!important}.dark .beginner-step span{color:#cbd5e1!important}.dark .nav-help{color:#bfdbfe!important}
@media(max-width:760px){.beginner-actions{grid-template-columns:1fr!important}.beginner-action-card{min-height:96px;padding:16px}.beginner-action-card b{font-size:18px}.beginner-steps{grid-template-columns:1fr 1fr!important}.nav-help{font-size:10px}}
@media(max-width:430px){.beginner-steps{grid-template-columns:1fr!important}}
...
def page(title, content, **context):
    ...
    display_title = {"POS":"Make Sale", "Products":"Check Stock", "Lens Powers":"Lens Stock", "Lens Restock Center":"Restock Lens", "Generate Power Grid":"Create Lens Powers", "Goods Requests":"Branch Requests", "Audit Trail":"Activity Record"}.get(title, title)
    nav = """
    ...
    <aside class="sidebar no-print">
        ...
        <nav>
            <div class="nav-group-title">Quick Actions</div>
            <div class="nav-section">
                <a class="simple-nav-link {% if active_path == '/pos' %}active{% endif %}" href="/pos"><strong>💰 Make Sale</strong><span class="nav-help">Sell lenses, frames and accessories</span></a>
                <a class="simple-nav-link {% if active_path == '/products' %}active{% endif %}" href="/products"><strong>📦 Check Stock</strong><span class="nav-help">View products and quantities</span></a>
                <a class="simple-nav-link {% if active_path == '/lens-restock-center' %}active{% endif %}" href="/lens-restock-center"><strong>➕ Restock Lens</strong><span class="nav-help">Add or correct lens stock</span></a>
                <a class="simple-nav-link {% if active_path == '/patient-rx' %}active{% endif %}" href="/patient-rx"><strong>👁️ Patient Rx</strong><span class="nav-help">Save patient prescriptions</span></a>
                <a class="simple-nav-link {% if active_path == '/debtors' %}active{% endif %}" href="/debtors"><strong>👥 Debtors</strong><span class="nav-help">See customers owing balance</span></a>
                <a class="simple-nav-link {% if active_path == '/daily-report' %}active{% endif %}" href="/daily-report"><strong>📊 Reports</strong><span class="nav-help">View daily sales summary</span></a>
            </div>

            <div class="nav-group-title">More Options</div>
            <div class="nav-section">
                <a class="simple-nav-link {% if active_path == '/sales' %}active{% endif %}" href="/sales"><strong>🧾 Sales History</strong><span class="nav-help">Check previous receipts</span></a>
                <a class="simple-nav-link {% if active_path == '/customer-history' %}active{% endif %}" href="/customer-history"><strong>📁 Customer History</strong><span class="nav-help">View customer records</span></a>
                <a class="simple-nav-link {% if active_path == '/debtor-reminders' %}active{% endif %}" href="/debtor-reminders"><strong>⏰ Debtor Reminder</strong><span class="nav-help">Send payment reminders</span></a>
                <a class="simple-nav-link {% if active_path == '/lens-powers' %}active{% endif %}" href="/lens-powers"><strong>🔍 Lens Stock</strong><span class="nav-help">Check exact lens powers</span></a>
                <a class="simple-nav-link {% if active_path == '/request-goods' %}active{% endif %}" href="/request-goods"><strong>🔄 Branch Request</strong><span class="nav-help">Request goods from another branch</span></a>
                <a class="simple-nav-link {% if active_path == '/goods-requests' %}active{% endif %}" href="/goods-requests"><strong>📥 Branch Requests</strong><span class="nav-help">Approve or track requests</span></a>
                <a class="simple-nav-link {% if active_path == '/notifications' %}active{% endif %}" href="/notifications"><strong>🔔 Notifications</strong><span class="nav-help">Messages and reminders</span></a>
            </div>

            {% if session['role'] == 'manager' %}
            <div class="nav-group-title">Manager Tools</div>
            <div class="nav-section">
                <a class="simple-nav-link {% if active_path == '/add-product' %}active{% endif %}" href="/add-product"><strong>➕ Add Product</strong><span class="nav-help">Create new stock items</span></a>
                <a class="simple-nav-link {% if active_path == '/add-lens-power' %}active{% endif %}" href="/add-lens-power"><strong>➕ Add Lens Power</strong><span class="nav-help">Add single lens power</span></a>
                <a class="simple-nav-link {% if active_path == '/generate-power-grid' %}active{% endif %}" href="/generate-power-grid"><strong>🧮 Create Lens Powers</strong><span class="nav-help">Generate many powers at once</span></a>
                <a class="simple-nav-link {% if active_path == '/branch-stock' %}active{% endif %}" href="/branch-stock"><strong>🏬 Branch Stock</strong><span class="nav-help">Compare stock by branch</span></a>
                <a class="simple-nav-link {% if active_path == '/smart-transfer' %}active{% endif %}" href="/smart-transfer"><strong>⚡ Smart Transfer</strong><span class="nav-help">Move goods between branches</span></a>
                <a class="simple-nav-link {% if active_path == '/staff' %}active{% endif %}" href="/staff"><strong>👨‍💼 Staff</strong><span class="nav-help">Manage staff accounts</span></a>
                <a class="simple-nav-link {% if active_path == '/branches' %}active{% endif %}" href="/branches"><strong>🏢 Branches</strong><span class="nav-help">Manage branch locations</span></a>
                <a class="simple-nav-link {% if active_path == '/security-settings' %}active{% endif %}" href="/security-settings"><strong>🔒 Security</strong><span class="nav-help">Change manager PIN</span></a>
                <a class="simple-nav-link {% if active_path == '/backup-center' %}active{% endif %}" href="/backup-center"><strong>💾 Backup</strong><span class="nav-help">Export or restore data</span></a>
                <a class="simple-nav-link {% if active_path == '/office-settings' %}active{% endif %}" href="/office-settings"><strong>⚙️ Settings</strong><span class="nav-help">Receipt name, phone, address</span></a>
                <a class="simple-nav-link {% if active_path == '/appearance' %}active{% endif %}" href="/appearance"><strong>🎨 Appearance</strong><span class="nav-help">Light or dark mode</span></a>
                <a class="simple-nav-link {% if active_path == '/audit-trail' %}active{% endif %}" href="/audit-trail"><strong>🧾 Activity Record</strong><span class="nav-help">Track sensitive activities</span></a>
            </div>
            {% endif %}
    ...
    """, title=title, display_title=display_title, active_path=active_path, Branch=Branch, User=User, Product=Product, LensPower=LensPower,
...
def mobile_more():
    ...
    <div class="card">
        <h2>More Options</h2>
        <p class="small">Beginner-friendly menu. Use the main buttons first; manager tools are kept here to avoid confusion.</p>
        <div class="mobile-more-grid">
            ...
            <a class="mobile-more-card" href="/lens-powers">🔍 Lens Stock</a>
            <a class="mobile-more-card" href="/lens-restock-center">➕ Restock Lens</a>
            <a class="mobile-more-card" href="/branch-stock">🏬 Branch Stock</a>
            <a class="mobile-more-card" href="/request-goods">🔄 Request Goods</a>
            <a class="mobile-more-card" href="/goods-requests">📥 Branch Requests</a>
            {% if session['role'] == 'manager' %}
            ...
            <a class="mobile-more-card" href="/generate-power-grid">🧮 Create Lens Powers</a>
            <a class="mobile-more-card" href="/security-settings">🔒 Security</a>
            <a class="mobile-more-card" href="/backup-center">💾 Backup</a>
            <a class="mobile-more-card" href="/office-settings">⚙️ Settings</a>
            <a class="mobile-more-card" href="/appearance">🎨 Appearance</a>
            <a class="mobile-more-card" href="/audit-trail">🧾 Activity Record</a>
            {% endif %}
...
def home():
    ...
    content = """
    <div class="card beginner-hero">
        <h2>Welcome, {{ session['username'] }}</h2>
        <p class="small">Start with the big buttons below. Advanced tools are under <b>More</b> or <b>Manager Tools</b>.</p>
        <p>Role: <b>{{ session['role'] }}</b></p>
        <p class="small">Data storage: <b>{{ using_database }}</b></p>
        <div class="beginner-actions">
            <a class="beginner-action-card" href="/pos" style="background:#16a34a"><b>💰 Make Sale</b><span>Sell lenses, frames, cases, cleaners and accessories.</span></a>
            <a class="beginner-action-card" href="/products" style="background:#0b4f86"><b>📦 Check Stock</b><span>View product quantities and prices.</span></a>
            <a class="beginner-action-card" href="/lens-restock-center" style="background:#f59e0b"><b>➕ Restock Lens</b><span>Add or correct lens power quantities.</span></a>
            <a class="beginner-action-card" href="/patient-rx" style="background:#7c3aed"><b>👁️ Patient Rx</b><span>Save customer prescription records.</span></a>
            <a class="beginner-action-card" href="/debtors" style="background:#dc2626"><b>👥 Debtors</b><span>Check customers with unpaid balance.</span></a>
            <a class="beginner-action-card" href="/daily-report" style="background:#475569"><b>📊 Reports</b><span>See daily sales and business summary.</span></a>
        </div>
    </div>
    ...
    <div class="grid">
        ...
        <div class="card stat"><h3>Total Lens Stock</h3><h1>{{ lens_powers }}</h1></div>
...
def products():
    ...
    <div class="card"><h2>Check Stock</h2><p class="small">Use this page to view products, prices and available quantity.</p>
    {% if session['role']=='manager' %}
...
def lens_powers():
    ...
    <div class="card"><h2>Lens Stock</h2><p class="small">Use this page to check exact lens powers and quantities.</p>
...
def lens_restock_center():
    ...
    <div class="card"><h2>Restock Lens</h2>
...
def generate_power_grid():
    ...
    {% if message %}<div class="alert success"><b>{{ message }}</b></div>{% endif %}
    <div class="card"><h2>Create Lens Powers</h2>
...
def pos():
    ...
    <div class="card beginner-hero">
        <h2>Make Sale</h2>
        <p class="small">Simple guided sale for new staff. Follow the steps below from customer details to receipt.</p>
        <div class="beginner-steps">
            <div class="beginner-step">Step 1<span>Customer Details</span></div>
            <div class="beginner-step">Step 2<span>Choose Lens / Frame</span></div>
            <div class="beginner-step">Step 3<span>Add To Cart</span></div>
            <div class="beginner-step">Step 4<span>Payment</span></div>
            <div class="beginner-step">Step 5<span>Print / WhatsApp Receipt</span></div>
        </div>
        <div class="help-note"><b>Tip:</b> For lenses, select Lens Type first, then material, then power. For frames and accessories, enter quantity and add to cart.</div>
        <div class="two">
