        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    ...
                    <form method="post" action="/delete-staff/{{ u.id }}" onsubmit="return confirm('Delete this staff account? Manager PIN is required.');">
...
def delete_staff(user_id):
    ...
    if not check_manager_pin(request.form.get("manager_pin")):
        return page("Wrong Manager PIN", "<div class='card danger'><h2>Wrong Manager PIN</h2><p>Staff deletion was blocked.</p><a class='btn' href='/staff'>Back</a></div>")
