...
def page(title, content, **context):
    ...
    """, Branch=Branch, User=User, Product=Product, LensPower=LensPower,
       Sale=Sale, SaleItem=SaleItem, OfficeSetting=OfficeSetting, session=session,
       money=money, **context)
...
def home():
    ...
    <div class="card"><h2>Menu</h2><nav>
        ...
        <a href="/office-settings" class="btn-gray">Office Settings</a><a href="/branches">Branches</a><a href="/add-staff">Add Staff</a>
        {% endif %}
